...
export default function ProductTikTok() {
  ...
  return (
    <main style={{ background: 'white', minHeight: '100vh', overflow: 'hidden' }}>
      ...
      {/* ── HERO ── */}
      <section className="hero-dark page-section-hero">
        {/* dot grid overlay */}
      ...
      <section className="page-section">
        <div className="page-inner">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'flex-start' }}>
            {/* Left */}
            <div>
              <h2 className="page-title" style={{ fontSize: 'clamp(26px, 3vw, 38px)', lineHeight: 1.18, marginBottom: 16 }}>
      ...
      {/* ── STATS BAR ── */}
      <section className="stats-bar" style={{ padding: '64px 48px' }}>
        <div style={{
      ...
      <section className="page-section">
        <div className="page-inner">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            <h2 className="page-title" style={{ fontSize: 'clamp(28px, 3.5vw, 44px)', marginBottom: 12 }}>
              Success Stories
            </h2>
